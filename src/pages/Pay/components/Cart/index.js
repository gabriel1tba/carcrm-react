...
import { change } from '../../../../store/actions/pay';
            ...
            {!pay_type && (
              <>
                ...
                <div
                  ...
                  onClick={() => dispatch(change({ pay_type: 'card' }))}
                >
                ...
                <div
                  className="d-flex pointer"
                  onClick={() => dispatch(change({ pay_type: 'pec' }))}
                >
                ...
                <div
                  className="d-flex pointer"
                  onClick={() => dispatch(change({ pay_type: 'bolbradesco' }))}
                >
                  <MdViewWeek className="display-4" />
                  <div className="ml-4 d-flex flex-column align-items-center">
                    <label className="h5 mb-1 mr-auto">Boleto bancário</label>
                    <label className="text-muted mr-auto">
                      O pagamento será aprovado em 1 ou 3 dias uteis
                    </label>
                  </div>
                </div>
              </>
