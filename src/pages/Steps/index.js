          ...
          <div className="card-body pt-5 pb-5">
            <div className="row">
              <div className="col-md-6">
                <h5>
                  Preparamos alguns passos para você deixar seu site do seu
                  jeito.
                </h5>
                ...
                <List component="nav">
                  ...
                  <ListItem button onClick={() => handlePage('domain')}>
                    ...
                    <ListItemText
                      className={(app.domain || app.subdomain) && 'disabled'}
                      primary="Configurar domínio"
                    />
                  </ListItem>
                  ...
                  <ListItem button component={Link} to="/vehicles">
                    ...
                    <ListItemText
                      className={app.vehicle && 'disabled'}
                      primary="Cadastrar seu primeiro veiculo"
                    />
                  </ListItem>
                </List>
              </div>
              ...
              <div className="col-md-6 text-center">
                <img className="img-fluid" src="/site.png" alt="" />
